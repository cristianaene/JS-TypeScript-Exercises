...
const starters : Array <CourseObject> = [
    {
...
const mainCourses : Array <CourseObject> = [
    {
...
const desserts : Array <CourseObject> = [
    {
...
const beverages : Array <CourseObject> = [
    {
...
//option 2
function addCourse (courses: Array <CourseObject>, containerId : string) {
